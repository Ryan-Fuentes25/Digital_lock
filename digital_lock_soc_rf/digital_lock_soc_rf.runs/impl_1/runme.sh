...
HD_PWD='C:/Users/fuent/.Xilinx/ECE520L/Sandbox/digital_lock_soc_rf/digital_lock_soc_rf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_lock_bd_rf_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_lock_bd_rf_wrapper.tcl -notrace
