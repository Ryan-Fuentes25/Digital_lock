...
HD_PWD='C:/Users/fuent/.Xilinx/ECE520L/Sandbox/digital_lock_soc_rf/digital_lock_soc_rf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_lock_bd_rf_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_lock_bd_rf_wrapper.tcl
