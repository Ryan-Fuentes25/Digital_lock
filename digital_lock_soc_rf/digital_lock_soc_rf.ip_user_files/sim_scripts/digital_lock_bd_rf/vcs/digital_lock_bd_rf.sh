...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.digital_lock_bd_rf xil_defaultlib.glbl -o digital_lock_bd_rf_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./digital_lock_bd_rf_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key digital_lock_bd_rf_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc digital_lock_bd_rf_simv.daidir vcs_lib c.obj)
