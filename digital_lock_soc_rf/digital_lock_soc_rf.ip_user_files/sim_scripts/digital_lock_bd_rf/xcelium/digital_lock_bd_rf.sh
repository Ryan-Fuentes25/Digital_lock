...
#
# Script generated by Vivado on Tue Apr 28 08:12:32 -0700 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : digital_lock_bd_rf.sh
...
#
# Usage        : digital_lock_bd_rf.sh
#                digital_lock_bd_rf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                digital_lock_bd_rf.sh [-reset_run]
#                digital_lock_bd_rf.sh [-reset_log]
#                digital_lock_bd_rf.sh [-help]
#
...
#                script (type 'digital_lock_bd_rf.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname generic_baseblocks_v2_1_0 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_register_slice_v2_1_28 -libname axi_protocol_converter_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "digital_lock_bd_rf.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./digital_lock_bd_rf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.digital_lock_bd_rf xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.digital_lock_bd_rf -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log digital_lock_bd_rf_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./digital_lock_bd_rf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: digital_lock_bd_rf.sh [-help]\n\
Usage: digital_lock_bd_rf.sh [-step]\n\
Usage: digital_lock_bd_rf.sh [-lib_map_path]\n\
Usage: digital_lock_bd_rf.sh [-reset_run]\n\
Usage: digital_lock_bd_rf.sh [-reset_log]\n\
Usage: digital_lock_bd_rf.sh [-keep_index]\n\
Usage: digital_lock_bd_rf.sh [-noclean_files]\n\n\
